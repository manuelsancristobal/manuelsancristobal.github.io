...
- **Análisis de Datos:** Python (Pandas, Scikit-learn), SQL.
- **Visualización:** Power BI, Mapbox, Deck.gl (ArcLayer, GreatCircleLayer).
- **Estadística:** Modelos de Regresión, Series de Tiempo, Clustering (K-Means, DBSCAN).
- **Web:** HTML5, CSS3, Jekyll (Liquid).
